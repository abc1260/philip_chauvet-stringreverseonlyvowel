...
public class ReverseStringSwapVowelsTest {

	@Test
	public void reverseUseCase1() {
		Instant before = Instant.now();

		String result = ReverseStringSwapVowels.reverseVowels(StringReverseUseCases.USECASE1);
	...
	public void reverseUseCase2() {
		...
		String result = ReverseStringSwapVowels.reverseVowels(StringReverseUseCases.USECASE2);
	...
	public void reverseUseCase3() {
		...
		String result = ReverseStringSwapVowels.reverseVowels(StringReverseUseCases.USECASE3);
	...
	public void reverseUseCase4() {
		...
		String result = ReverseStringSwapVowels.reverseVowels(StringReverseUseCases.USECASE4);
	...
	public void reverseUseCase5() {
		...
		String result = ReverseStringSwapVowels.reverseVowels(StringReverseUseCases.USECASE5);
	...
	public void reverseUseCase6() {
		...
		String result = ReverseStringSwapVowels.reverseVowels(StringReverseUseCases.USECASE6);
